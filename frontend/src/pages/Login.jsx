            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#2c5282] to-[#4299e1] flex-col justify-center items-center text-white p-12 relative overflow-hidden">
                <div className="z-10 text-center max-w-md">
                    ...
                    <p className="text-lg text-blue-100 opacity-90 italic">
                        "ScribeAI's automated meeting analysis has transformed how our team collaborates. We save hours every week."
                    </p>
                    <p className="mt-4 text-sm font-medium text-blue-200">
                        — Sarah Jenkins, Product Lead at TechCorp
                    </p>
                </div>
                    ...
                    <div className="mt-8">
                        <div className="mt-6">
                            ...
                            <div className="mt-8 text-center text-sm text-gray-600">
                                Don't have an account? <a href="#" className="font-medium text-[#2f5c96] hover:underline">Sign up</a>
                            </div>
                        </div>
                    </div>
                </div>
